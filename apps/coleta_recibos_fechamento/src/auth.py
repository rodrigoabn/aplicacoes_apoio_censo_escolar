...
de login/senha para ACESSAR o sistema e BAIXA os recibos de fechamento (PDF)
que o próprio Educacenso disponibiliza. Nenhum dado do site é alterado,
nenhum formulário de questionário é submetido/salvo.
"""
