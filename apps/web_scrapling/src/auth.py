...
Aplicação ESTRITAMENTE em modo leitura: apenas NAVEGA e PREENCHE os campos
de login/senha para ACESSAR o sistema e ler dados. Nenhum dado do site é
alterado, nenhum formulário de questionário é submetido/salvo.
"""
